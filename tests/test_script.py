...
class TestScript(unittest.TestCase):
    def test_script_okay(self):
        ...
        self.assertEqual(input, b'OKAY: mailq count and size okay | count=7;10;20;; recipients=10;0;0;; size=107800B;0;0;;\n')
    ...
    def test_script_sender_filter(self):
        ...
        self.assertEqual(input, b'OKAY: mailq count and size okay | count=2;10;20;; recipients=10;0;0;; size=33217B;0;0;;\n')
